...
export const WorkshopSection = () => {
  ...
  return (
    ...
    >
      <div className="flex min-w-[80%] flex-col items-center gap-2 self-center bg-orange px-2 py-1 text-white shadow-[-2rem_2rem_0.25rem_0_rgba(226,108,89,0.25)]">
        <div className="flex flex-col gap-1 text-center">
          ...
          <p className={styles.heading.sub}>Workshop interactif et pratique</p>
        </div>
